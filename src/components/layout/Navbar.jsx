    ...
    },
    {
      ...
      featured: [
        ...
        },
        {
          ...
          href: '#',
          imageSrc: '../../sac_yonex2',
          imageAlt: 'Sac de Badminton Yonex rouge à 4 poches.',
        },
      ],
      sections: [
        {
...
export default function Example() {
  ...
  // ✅ Connexion au Context pour le compteur du panier
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                {/* ✅ Cart — Link au lieu de a href + compteur dynamique */}
