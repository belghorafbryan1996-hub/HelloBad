  ...
  return (
    <div className="w-full bg-white text-gray-800 text-sm border-t border-gray-200">
      ...
      <div className="p-5 sm:w-2/12 border-r">
          <div className="text-sm uppercase text-cyan-400 font-bold">Menu</div>
            <ul>
              ...
              <li className="my-2"><Link className="hover:text-indigo-600" to="/mentionlegale">Mention Legale</Link></li>
              <li className="my-2"><Link className="hover:text-indigo-600" to="/cgv">Condition général de vente</Link></li>
            </ul>
        </div>

        {/* Centre */}
        <div className="p-5 sm:w-7/12 border-r text-center">
          <h3 className="font-bold text-xl text-cyan-400 mb-4">HELLOBAD</h3>
        ...
        <div className="p-5 sm:w-3/12"> 
          <div className="text-sm uppercase text-cyan-400 font-bold">Contact</div>
                <ul>
                  <li className="my-2">
              ...
              <Link to="/contact">
                  <button className = "  text-white py-2 px-4 rounded-full bg-indigo-400 shadow-lg shadow-indigo-600/50" >
                    Contactez-nous
                  </button>
              </Link> 
    ...
    {/* Je choisi de hide volontairement et de ne pas supprimer les reseaux que je n'utilise pas car ils ont déjà présent sur le template tailwind et à l'avenir il est probable que je les utilise. */}
      ...
      <div className="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-screen-xl">
        <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex gap-2 item-center">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/juste.bry/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-6 mx-1"className="w-6 mx-1">
            <svg className="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" >
